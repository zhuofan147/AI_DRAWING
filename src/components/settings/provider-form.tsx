...
import { Loader2, Download, Plus, Eye, EyeOff, Trash2, Search, Wifi } from "lucide-react";
      ...
      <div className="flex items-center gap-3">
        <Button
          ...
          disabled={
            ...
            !provider.baseUrl ||
            !provider.apiKey ||
            (provider.protocol === "kling" && !provider.secretKey)
          }
          className="gap-1.5"
        >
          {testing ? (
          ...
          {testing ? t("testConnectionTesting") : t("testConnection")}
        </Button>
        {testResult && (
          <span
